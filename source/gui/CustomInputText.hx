 ...
 */
class CustomInputText extends FlxText 
{		
	...
	*/
	...
	public function new(X:Float = 0, Y:Float = 0, Width:Int = 150, ?Text:String, size:Int = 8, 
		TextColor:Int = FlxColor.BLACK, BackgroundColor:Int = FlxColor.WHITE, EmbeddedFont:Bool = true, ?fontType:String)
	{
		super(X, Y, Width, Text, size, EmbeddedFont);
		setFormat(fontType, size, TextColor);
